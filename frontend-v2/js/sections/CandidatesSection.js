        ...
        return `
            ...
            <div class="candidates-container">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2.5rem; flex-wrap: wrap; gap:1.5rem;">
                    ...
                    <button id="add-cand-btn" class="btn btn-primary" style="box-shadow: 0 4px 12px rgba(var(--primary-color-rgb), 0.2);"><i class="fas fa-user-plus"></i> ${labels.addCandidate}</button>
                </div>
