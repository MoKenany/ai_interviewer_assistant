...
from app.models.interview_session import SessionTypeEnum, SessionAIModeEnum, PipelineStatusEnum
...
class SessionCreate(BaseModel):
    ...
    ai_mode: SessionAIModeEnum = SessionAIModeEnum.normal
