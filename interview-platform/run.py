...
def cleanup_and_exit_tree():
    ...
    print("\n[INFO] Gracefully stopping Celery and Redis...")
    ...
    print("[INFO] Forcefully terminating Uvicorn reload process tree...")
...
def start_services():
    ...
    try:
        ...
        print("[OK] Celery Worker launched (separate terminal opened for logs).")
    except Exception as e:
        print(f"[ERROR] Failed to start Celery Worker: {e}")

    print()
    print("[OK] Starting FastAPI server on http://127.0.0.1:8000 ...")
